...
public class MainActivity extends AppCompatActivity {
    ...
    private void showResult(){
        ...
        View view=inflater.inflate(R.layout.activity_result_,null);
        ((TextView) view.findViewById(R.id.result_message)).setText("you got "  +  score  +  " out of " + numberOfQuestions );
        ...
        builder.setNegativeButton("share result", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                shareIntent = new Intent(Intent.ACTION_SEND);
                shareIntent.setType("text/plain");
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "My Score!");
                shareIntent.putExtra(Intent.EXTRA_TEXT,  " I got " + score + " out of 9 in Quiz 1: Makhaarij. " +
                        " What did you get? ");
